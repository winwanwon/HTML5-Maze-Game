...
<body>
  ...
  <![endif]-->
    <div id="main">
      <div id="content">
        ...
        <audio preload="true" id="bgm">
          <source src="sounds/bgm_canabalt.mp3"/>
        </audio>
        <audio preload="true" id="keypick">
          <source src="sounds/keypick.mp3"/>
        </audio>
        <audio preload="true" id="dead">
          <source src="sounds/dead_sound.mp3"/>
        </audio>
        <audio preload="true" id="complete">
          <source src="sounds/mario_complete.mp3"/>
        </audio>
      </div> <!-- /content -->
    </div> <!-- /main -->
      ...
      <div class="row">
        <div class="col-md-6 col-md-offset-3">
          <div class="box">
            ...
            <h3 id="score" style="font-weight:100;">SCORE: 1000000</h3>
            <hr>
  ...
  <?php
    ...
    if($hero=="Megaman"){
      echo 'player_image = "images/player.png"; hero = "megaman";';
    } else if($hero="Kirby") {
      echo 'player_image = "images/kirby_sprite.png"; hero = "kirby";';
    }
    ...
    if($theme=="City"){
      ...
      echo 'tile_image = "images/block_spike.png";';
      echo 'background_image ="images/block_greytile.png";';
    }
